...
var ModificarVariables2 = /** @class */ (function (_super) {
    __extends(ModificarVariables2, _super);
    function ModificarVariables2() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    ModificarVariables2.prototype.ModificarVariables2 = function (val) {
        this.Nombre = val;
        this.id = 0;
        this.linea = 0;
        this.columna = 0;
    ...
    ModificarVariables2.prototype.Ejecutar = function (entorno) {
