...
var VariablesGlobales = /** @class */ (function (_super) {
    __extends(VariablesGlobales, _super);
    function VariablesGlobales() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    VariablesGlobales.prototype.VariablesGlobales = function (val) {
        this.Nombre = val;
        this.id = 0;
        this.linea = 0;
        this.columna = 0;
    ...
    VariablesGlobales.prototype.Ejecutar = function (entorno) {
