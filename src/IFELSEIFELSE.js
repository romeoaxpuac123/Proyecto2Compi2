...
var IFELSEIFELSE = /** @class */ (function (_super) {
    __extends(IFELSEIFELSE, _super);
    function IFELSEIFELSE() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    IFELSEIFELSE.prototype.IFELSEIFELSE = function (val) {
        this.Nombre = val;
        this.id = 0;
        this.linea = 0;
        this.columna = 0;
    ...
    IFELSEIFELSE.prototype.Ejecutar = function (entorno) {
