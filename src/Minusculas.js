...
var Minusculas = /** @class */ (function (_super) {
    __extends(Minusculas, _super);
    function Minusculas() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    Minusculas.prototype.Minusculas = function (val) {
        this.Nombre = val;
        this.id = 0;
        this.linea = 0;
        this.columna = 0;
    ...
    Minusculas.prototype.Ejecutar = function (entorno) {
        ...
        entorno.direccion += "  if(" + "t" + entorno.numero + " == 32) goto L" + Etiqueta3 + ";\n";
